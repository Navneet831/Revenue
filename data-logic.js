 ...
 * Implements Dependency Inversion by using clean input parameters.
 */
class RevenueComputeEngine {
    ...
    compute() {
        ...
        const buckets = { chart: { monthly: {}, weekly: {}, daily: {} } };
        ...
        const qtrMap = { 3: 0, 4: 0, 5: 0, 6: 1, 7: 1, 8: 1, 9: 2, 10: 2, 11: 2, 0: 3, 1: 3, 2: 3 };
        ...
        // Pre-build index sets for fast filter evaluations
        const excludedSet = f.excludedSeries || new Set();

        // 1. First Pass: Compute historical pacing datasets (independent of current time filters)
