...
export const AppFooter: React.FC = () => {
    ...
    return (
        <div className="shrink-0 h-7 border-t border-slate-200 bg-white flex items-center justify-between px-4 text-[9px] font-black text-black uppercase tracking-widest select-none">
