...
export const LoginForm: React.FC<LoginFormProps> = ({
    ...
    <form onSubmit={onSubmit} className="space-y-6">
        ...
        <button type="submit" disabled={loading} className="auth-btn-primary w-full text-xs font-black py-3.5 rounded-xl flex items-center justify-center gap-2 uppercase tracking-widest cursor-pointer">
            {loading ? <div className="auth-loader w-4 h-4 border-[2px]" /> : otpMode ? 'Verify Authorization Array' : 'Verify Email Access'}
        </button>
        ...
        {!otpMode && (
            <>
                ...
                <button type="button" onClick={onGoogleLogin} className="auth-btn-google w-full text-xs font-bold py-3.5 rounded-xl flex items-center justify-center gap-2 cursor-pointer">
