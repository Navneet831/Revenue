...
test.describe('Authentication Enforcement Mandate', () => {
    ...
    test('STRICT: should remain at login screen for unauthenticated sessions', async ({ page }) => {
        ...
        // It could be either the "Manual Access Login" button or the glass login card
        const authContainer = page.locator('#auth-layer');
        ...
        await expect(manualLoginBtn.or(authUI)).toBeVisible();
